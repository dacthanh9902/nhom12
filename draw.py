...
class Drawing:
    ...
    def init_gui(self):
        ...
        self.root = Tk()
        self.root.title(f"Image Recognition Classifier By Vu Phuong - {self.proj_name}")
    ...
    def train_model(self):
        ...
        tkinter.messagebox.showinfo("Image Recognition Classifier", "Model successfully trained!", parent=self.root)
    ...
    def predict(self):
        ...
        if prediction[0] == 1:
            tkinter.messagebox.showinfo("Image Recognition Classifier", f"The drawing is probably a {self.class1}", parent=self.root)
        elif prediction[0] == 2:
            tkinter.messagebox.showinfo("Image Recognition Classifier", f"The drawing is probably a {self.class2}", parent=self.root)
        elif prediction[0] == 3:
            tkinter.messagebox.showinfo("Image Recognition Classifier", f"The drawing is probably a {self.class3}", parent=self.root)
